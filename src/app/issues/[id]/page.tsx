  ...
  return (
    <main className="max-w-225 mx-auto w-full flex flex-col gap-4 p-6 bg-navy-800 border-[0.5px] border-navy-500 rounded-xl">
      ...
      <div className="flex flex-col gap-2">
        ...
        <form className="relative full">
          <Input className="bg-navy-900 h-11 pr-24 w-full" />
          <button
            type="submit"
            className={`
              flex items-center gap-2 text-indigo-400 absolute right-3 
              top-1/2 -translate-y-1/2 text-xs hover:text-indigo-300 
